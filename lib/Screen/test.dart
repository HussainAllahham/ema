                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (employer_name_regex.hasMatch(value!) == false) {
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (Employer_age_regex.hasMatch(value!) == false) {
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (Employer_position_regex.hasMatch(value!) ==
                                false) {
                        ...
                        builder: (context, state) {
                          return IconButton(
                              ...
                              icon: Image.asset(icons[11],
                                  scale: 1.7,
                                  color: (image_uploaded_successfuly == false &&
                                          submitted == true)
                                      ? Colors.red
                                ...
                                Container(
                                  child: Row(children: [
                                    Radio(
                                      ...
                                      onChanged: (value) {
                                        gender_current_option = 0;
                                        context.read<UsersDataCubit>().Gender();
                                      },
                                    ),
                                    InkWell(
                                      child: Text('Male'),
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if (_formkey.currentState!.validate()) {
                            ...
                            Supabase.initialize(
                              url: 'https://oarqjspwajbojrddcvky.supabase.co',
                              anonKey:
                            ...
                            postUsersData = {
                              ...
                              "gender": (gender_current_option == 0)
                                  ? "male"
                                  : "female",
                              "salary_type": (salary_type_current_option == 0)
                                  ? "Monthly"
                                  : (salary_type_current_option == 1)
                                      ? "Weekly"
                                      : "Daily",
                              ...
                              //     "Empty",
                              // "shiftId": shiftId,
                              "shiftId": (selectedShiftItem_adding != null)
                                  ? shift_id_items[shift_items
                                      .indexOf(selectedShiftItem_adding!)]
                                  : "Empty",
