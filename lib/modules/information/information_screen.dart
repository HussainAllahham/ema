...
import 'package:emas/modules/information/cubit/information_cubit.dart';
import 'package:emas/modules/information/cubit/information_states.dart';
import 'package:emas/modules/information/edit_number/edit_number_screen.dart';
...
class InformationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => InformationCubit()..getData(id: 'eq.1'),
                  ...
                  child: Container(
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            '${cubit.informationModel?.shiftId ?? ''}',
                            style: TextStyle(
                              fontSize: 24,
                            ),
                          ),
                  ...
                  child: Container(
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            '${cubit.informationModel?.departmentId ?? ''}',
                            style: TextStyle(
                              fontSize: 24,
                            ),
                          ),
