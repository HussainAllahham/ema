...
import 'package:emas/Screen/manger%20screens/adding_employee_to_department_and_to_shift.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          //                   onChanged: (text) {
          //                     search_users_text_department = "";
          //                     search_users_text_department = text;
          //                     context.read<UsersDataCubit>().getUsersData();
          //                     // print(search_text);
          //                   },
          //                   // validator: (value) {
                                                              ...
                                                              children: [
                                                                ElevatedButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    print(
                                                                        'delete employee : ${users[index].id} from department: ${users[index].departmentId} //**');
                                                                    context
                                                                        .read<
                                                                            UsersDataCubit>()
                                                                        .getUsersData();
...
// class DepartmentEmployeeList extends StatelessWidget {
//   const DepartmentEmployeeList({super.key});
